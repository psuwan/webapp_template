<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 " id="sidenav-main">
    ...
    <div class="collapse navbar-collapse  w-auto h-auto" id="sidenav-collapse-main">
        <ul class="navbar-nav">
            ...
            <!-- Datas -->
            <li class="nav-item">
                <a data-bs-toggle="collapse" href="#datasExamples" class="nav-link " aria-controls="datasExamples" role="button" aria-expanded="false">
                    <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center d-flex align-items-center justify-content-center  me-2">
                ...
                <div class="collapse " id="datasExamples">
                    <ul class="nav ms-4 ps-3">
                        <li class="nav-item ">
                            <a class="nav-link " href="?page=data&action=view&machine=1">
                                <span class="sidenav-mini-icon"> S </span>
                                <span class="sidenav-normal"> Machine #01 </span>
                            </a>
                        </li>
            ...
            <li class="nav-item">
                ...
                <div class="collapse " id="reportsExamples">
                    <ul class="nav ms-4 ps-3">
                        <li class="nav-item ">
                            <a class="nav-link " href="?page=report&action=view&machine=1">
                                <span class="sidenav-mini-icon"> S </span>
                                <span class="sidenav-normal"> Machine #01 </span>
                            </a>
                        </li>
