<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 " id="sidenav-main">
    <div class="sidenav-header">
        ...
        <a class="navbar-brand m-0" href=" https://www.apks-software.com " target="_blank">
            <img src="./assets_softui/img/apks_logo_ok_02.svg" class="navbar-brand-img h-100" alt="main_logo">
    ...
    <div class="collapse navbar-collapse  w-auto h-auto" id="sidenav-collapse-main">
        <ul class="navbar-nav">
            ...
            <!-- Dashbaord -->
            <li class="nav-item">
                <a data-bs-toggle="collapse" href="#dashboardsExamples" class="nav-link <?php hiligh_menu_single_level_check(get('page'), 'dashboard', 'active'); ?>" aria-controls="dashboardsExamples" role="button" aria-expanded="false">
                ...
                <div class="collapse <?php hiligh_menu_single_level_check(get('page'), 'dashboard', 'show'); ?>" id="dashboardsExamples">
                    <ul class="nav ms-4 ps-3">
                        ...
                        <li class="nav-item ">
                            <a class="nav-link <?php hiligh_menu_double_level_check(get('page'), get('machine'), 'dashboard', 'mch01', 'active'); ?>" href="?page=dashboard&action=view&machine=mch01">
            ...
            <!-- Datas -->
            <li class="nav-item">
                <a data-bs-toggle="collapse" href="#datasExamples" class="nav-link <?php hiligh_menu_single_level_check(get('page'), 'data', 'active'); ?>" aria-controls="datasExamples" role="button" aria-expanded="false">
                    <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center d-flex align-items-center justify-content-center  me-2">
                ...
                <div class="collapse <?php hiligh_menu_single_level_check(get('page'), 'data', 'show'); ?>" id="datasExamples">
                    <ul class="nav ms-4 ps-3">
                        <li class="nav-item ">
                            <a class="nav-link <?php hiligh_menu_double_level_check(get('page'), get('machine'), 'data', 'mch01', 'active'); ?>" href="?page=data&action=view&machine=mch01">
                                <span class="sidenav-mini-icon"> S </span>
                                <span class="sidenav-normal"> Machine #01 </span>
                            </a>
                        </li>
            ...
            <!-- Reports -->
            <li class="nav-item">
                <a data-bs-toggle="collapse" href="#reportsExamples" class="nav-link <?php hiligh_menu_single_level_check(get('page'), 'report', 'active'); ?>" aria-controls="reportsExamples" role="button" aria-expanded="false">
                    <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center d-flex align-items-center justify-content-center  me-2">
                ...
                <div class="collapse <?php hiligh_menu_single_level_check(get('page'), 'report', 'show'); ?>" id="reportsExamples">
                    <ul class="nav ms-4 ps-3">
                        <li class="nav-item ">
                            <a class="nav-link <?php hiligh_menu_double_level_check(get('page'), get('machine'), 'report', 'mch01', 'active'); ?>" href="?page=report&action=view&machine=mch01">
                                <span class="sidenav-mini-icon"> S </span>
                                <span class="sidenav-normal"> Machine #01 </span>
                            </a>
                        </li>
    ...
    <div class="sidenav-footer mx-3 mt-3 pt-3">
        <div class="card card-background shadow-none card-background-mask-secondary" id="sidenavCard">
            <div class="full-background" style="background-image: url('./assets_softui/img/curved-images/white-curved.jpg')"></div>
